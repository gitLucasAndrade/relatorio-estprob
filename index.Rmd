---
title: "Relatórios da Disciplina - Estatística e Probabilidade "
...
Acesse: [Lucas Andrade](info/index.html){target="_blank"}

# Página dos alunos da disciplina

- Acesse: [Página dos alunos da disciplina MA 41 (PROFMAT)](https://gitLucasAndrade.github.io/relatorio-estprob/){target="_blank"}
# Visão geral sobre os relatórios {.tabset .tabset-fade}

Este projeto está disponível em <https://gitLucasAndrade.github.io/relatorio-estprob/>.
...
usethis::use_git_config(user.name = "gitLucasAndrade", user.email = "l.reisoandrade@gmail.com")
# gerando um token
...
- Uma vez projeto local no github, vamos ativar a página:
  ...
  - Pronto! Estando tudo certo, a página pode ser acessada com o link: `https://bendeivide.github.io/relatorio-estprob/.`. Bons estudos!
